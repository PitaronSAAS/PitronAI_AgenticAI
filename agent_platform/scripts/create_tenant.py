...
"""
import argparse, secrets, json, os, sys
...
def main():
    ...
    t = sb.table("tenants").insert({
        ...
        "api_key": api_key, "plan": args.plan, "status": "active",
        "allowed_origins": [],
    }).execute().data[0]
    ...
    print(f"   Embed   : <script src=\"https://api.pitronai.pro/widget/widget.js\" data-agent-slug=\"{args.slug}\"></script>\n")
